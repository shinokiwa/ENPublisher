...
describe('flows.dologin', function() {
	describe('#c(response,output,next)', function (){
	...
	describe('#m(ID,Password)(Input,Output,next)', function(done){
		it('未ログイン時のみ、IDとパスワードを与えられた値と比較し、セッションとOutputに結果を代入する。', function (done){
			...
			var output = {};
			flow.m('TestID', 'TestPassword')(input, output, function () {
